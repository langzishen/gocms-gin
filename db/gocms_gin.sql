...
CREATE TABLE `article`  (
  ...
  `tid` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '所属分类',
  `title` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '文章标题',
  `keywords` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '关键字',
  `description` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '描述',
  `img` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '预览图片',
  `content` longtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '内容',
  `create_time` int NOT NULL COMMENT '录入时间',
  `update_time` int NOT NULL COMMENT '修改时间',
  `creater_id` int UNSIGNED NOT NULL COMMENT '录入人',
  `sort` smallint NOT NULL DEFAULT 0 COMMENT '排序值',
  `apv` smallint NOT NULL DEFAULT 0 COMMENT '浏览量',
  `rewrite` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'URL重写值',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态 1:启用,0:禁用',
  `template` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '使用模板',
  `attrtj` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '推荐属性',
  `outurl` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '外部网址',
  `is_login_show` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否需要登录才显示',
...
CREATE TABLE `attribute`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'id',
  `model_ename` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '对应模型名称',
  `attrname` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '属性名称',
  `attrvalue` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '属性值',
  `sort` mediumint NOT NULL DEFAULT 999 COMMENT '排序值',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态 1:启用,0:禁用',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `category`  (
  `classid` int NOT NULL AUTO_INCREMENT COMMENT '栏目id',
  `classpid` int NOT NULL DEFAULT 0 COMMENT '栏目父id',
  `classpids` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '栏目父ids',
  `classchild` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否有下级',
  `classchildids` varchar(2000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '栏目下级ids',
  `classarrchildids` mediumtext CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '栏目下级对象',
  `classtitle` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '栏目标题',
  `classsort` smallint NOT NULL DEFAULT 0 COMMENT '排序',
  `classstatus` tinyint(1) NOT NULL DEFAULT 1 COMMENT '状态',
  `classkeywords` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '关键字',
  `classdescription` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '描述',
  `classmodule` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '所属模型',
  `classrewrite` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT 'URL重写值',
  `classtemplate` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '栏目模版',
  `newstemplate` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '文章模版',
  `classimg` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '栏目预览图',
  `classapv` int NOT NULL DEFAULT 0 COMMENT '栏目浏览量',
  `classdomain` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '栏目二级域名',
  `classouturl` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '栏目外部网址',
...
CREATE TABLE `data_access`  (
  ...
  `tid` int UNSIGNED NOT NULL COMMENT '分类ID',
  `model` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '模型名称',
  `create_time` int UNSIGNED NOT NULL COMMENT '添加时间'
...
CREATE TABLE `log_login`  (
  ...
  `last_login_time` int UNSIGNED NOT NULL COMMENT '最后的登陆时间',
  `login_app` varchar(80) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '登录的应用平台',
  `from` tinyint UNSIGNED NOT NULL DEFAULT 1 COMMENT '来源：1为web2为android3为ios',
  `last_login_ip` varchar(16) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '最后登录的Ip',
  `device_token` varchar(200) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '登录的设备唯一标识',
  `count` int UNSIGNED NOT NULL COMMENT '登录的次数',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 149 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '登陆记录表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `model`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '模型表',
  `ename` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '模块名称',
  `cname` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '显示名称',
  `notes` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL COMMENT '应用描述',
  `menugroup` tinyint NOT NULL DEFAULT 2 COMMENT '属于大菜单',
  `sort` tinyint NOT NULL DEFAULT 1 COMMENT '排序',
  `author` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '开发作者',
  `version` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '' COMMENT '版本',
...
CREATE TABLE `node`  (
  ...
  `icon` varchar(1000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '图标',
...
CREATE TABLE `photo`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '逐渐自增',
...
CREATE TABLE `user`  (
  `id` int UNSIGNED NOT NULL AUTO_INCREMENT,
  `object_id` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '用户唯一标识',
  `account` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT '用户名',
  ...
  `type_id` tinyint UNSIGNED NOT NULL DEFAULT 0 COMMENT '9为后台超级管理员',
